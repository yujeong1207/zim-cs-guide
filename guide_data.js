/* ===== guide_data.js : original lines 1103-15165 ===== */
/* =========================================================================
   기본 데이터
   ========================================================================= */

// DEFAULT_TEMPLATES 삭제됨 - 메일 템플릿(화주 응대 모음)은 이제 Firestore(mail_templates 컬렉션)에서 관리돼요.
// 실시간 동기화 로직은 guide_mail_templates_firestore.js 참고.
    ...
    "subItems": [
      ...
      },
      {
        ...
        "steps": [
          ...
          "DEL 란에 도착지가 기입되어 있으면 선사 운송분 - 라인운송사 '화성'(051-631-5261) 안내 (ZNP는 '티와이엑스'(070-4991-0486))",
...
/* ⚠️ 복구됨: 이전 병합 과정에서 선언이 누락되어있던 상수 (2026-08-17) */
...
const DEFAULT_TT_LINES = [
  {
    ...
    "ports": [
      ...
      },
      {
        ...
        "name": "Charleston",
        "tt": 28,
        "url": "https://scspa.com/cargo/vessels/vessel-schedule/"
      },
      {
        "id": "ttp_4",
        "code": "USSAV",
        "name": "Savannah",
        "tt": 29,
        "url": "https://gaports.com/vessel-schedule/"
      },
      {
        "id": "ttp_5",
        "code": "USJAX",
        "name": "Jacksonville",
        "tt": 32,
        "url": "https://vesselschedule.jaxport.com/webx/"
      }
    ]
  },
  {
    ...
    "ports": [
      {
        ...
        "name": "New York",
        "tt": 27,
        "url": "https://www.pnct.net/VesselSchedule"
      },
      {
        "id": "ttp_7",
        "code": "USBAL",
      ...
      },
      {
        ...
        "name": "Norfolk",
        "tt": 33,
        "url": "https://vessels.portofvirginia.com/"
      },
      {
        "id": "ttp_9",
        "code": "USPEL",
  ...
  },
  {
    ...
    "ports": [
      ...
      },
      {
        ...
        "name": "Miami",
        "tt": 35,
        "url": "https://pomtoc.com/vessel-schedules/"
      }
    ]
  },
  {
    ...
    "ports": [
      {
        ...
        "name": "Vancouver",
        "tt": 14,
        "url": "https://globalterminals.com/terminal-operations/gate-schedule/"
      },
      {
        "id": "ttp_16",
        "code": "CAPRP",
  ...
  },
  {
    ...
    "ports": [
      ...
      },
      {
        ...
        "name": "Hong Kong",
        "tt": 11,
        "url": "https://www.modernports.com.hk/mtlportal/public-enquiry/vessel-schedule"
      },
      {
        "id": "ttp_32",
        "code": "CNOJA",
      ...
      },
      {
        ...
        "name": "Brisbane",
        "tt": 23,
        "url": "https://elink.patrick.com.au/elink/"
      },
      {
        "id": "ttp_34",
        "code": "AUSYD",
...
/* 도착지 연락처 (엑셀 붙여넣기로 관리) */
// DEFAULT_CONTACTS 삭제됨 - 참고자료 > 연락처는 이제 Firestore(reference_contacts 컬렉션)에서 관리돼요.
// 실시간 동기화 로직은 guide_ref_contacts_firestore.js 참고.
